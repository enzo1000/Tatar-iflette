...
public static class WallGenerator
{
    ...
    private static void CreateBasicWall(TilemapVisualizer tilemapVisualizer, HashSet<Vector2Int> basicWallPositions, HashSet<Vector2Int> floorPositions)
    {
        foreach (Vector2Int position in basicWallPositions)
        {
            ...
            //We loop through all the cardinal directions to check if there is a floor tile in that direction
    ...
    private static HashSet<Vector2Int> FindWallsInDirection(HashSet<Vector2Int> floorPositions, List<Vector2Int> directionList)
    {
        ...
        foreach (Vector2Int position in floorPositions)
        {
            ...
            {
                var neighbourPosition = position + direction;
                //Si on ne trouve pas la position voisine dans les positions de sol, alors c'est un mur
